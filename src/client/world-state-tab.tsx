...
const S: Record<string, CSSProperties> = {
  ...
  activityHead: { fontSize: 11, fontWeight: 600, color: 'var(--dsw-alias-label-secondary)', letterSpacing: '0.02em', marginBottom: 2 },
  ...
  cardLabel: { fontSize: 11.5, fontWeight: 600, color: 'var(--dsw-alias-label-secondary)', flex: 1 },
  field: { display: 'flex', flexDirection: 'column', gap: 5, minWidth: 0 },
  fieldLabel: { fontSize: 11, fontWeight: 500, color: 'var(--dsw-alias-label-tertiary)' },
  grid2: { display: 'flex', gap: 10 },
