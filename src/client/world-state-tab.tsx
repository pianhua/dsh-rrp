          ...
          {draft.characters.map((row, index) => (
            <div key={rowKeys.characters[index]} style={S.card}>
              ...
              <Field
                ...
                onChange={(v) =>
                  mutate((d) => {
                    d.characters[index].appearance = v
                  })
                }
              />
              <Field
                ...
                onChange={(v) =>
                  mutate((d) => {
                    d.characters[index].condition = v
                  })
                }
              />
            </div>
